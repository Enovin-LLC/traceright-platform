...
// Variables can be defined inline as well.
const { data } = await addNewProduct({ name: ..., description: ..., price: ..., sku: ..., });
...
// Variables can be defined inline as well.
const ref = addNewProductRef({ name: ..., description: ..., price: ..., sku: ..., });
...
// Variables can be defined inline as well.
const { data } = await updateProduct({ id: ..., name: ..., description: ..., price: ..., sku: ..., });
...
// Variables can be defined inline as well.
const ref = updateProductRef({ id: ..., name: ..., description: ..., price: ..., sku: ..., });
