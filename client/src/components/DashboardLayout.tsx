...
const menuItems = [
  ...
  { icon: Boxes, label: "Batches", path: "/batches" },
    ...
    <>
      ...
      <SidebarInset>
        ...
        <main className="flex-1">
          {!isMobile && (
            <div className="flex items-center justify-end border-b h-14 px-4 bg-background/95 backdrop-blur supports-[backdrop-filter]:backdrop-blur sticky top-0 z-40">
              <Button
                variant="ghost"
                size="icon"
                onClick={toggleTheme}
